...
use super::{command::SwarmdCommand, login::LoginArg};
...
pub enum Commands {
    /// Login to Swarmd Edge network with your account and allow you to deploy workers for every
    /// orgs where you are a member.
    Login(LoginArg),
}
