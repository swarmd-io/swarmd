...
pub async fn organization_id_project_create_post(
    configuration: &configuration::Configuration,
    organization_id: &str,
    create_project_payload: crate::models::CreateProjectPayload,
) -> Result<crate::models::CreateProjectResponse, Error<OrganizationIdProjectCreatePostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/{organization_id}/project/create",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrganizationIdProjectCreatePostError> =
...
pub async fn organization_id_project_get(
    configuration: &configuration::Configuration,
    organization_id: &str,
    list_projects_params: crate::models::ListProjectsParams,
) -> Result<crate::models::ListProjectResponse, Error<OrganizationIdProjectGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrganizationIdProjectGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn organization_id_project_project_id_publish_put(
    configuration: &configuration::Configuration,
    organization_id: &str,
    project_id: &str,
    publish_worker_payload: crate::models::PublishWorkerPayload,
) -> Result<
    crate::models::PublishWorkerResponse,
    Error<OrganizationIdProjectProjectIdPublishPutError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        "{}/{organization_id}/project/{project_id}/publish",
        local_var_configuration.base_path,
        organization_id = crate::apis::urlencode(organization_id),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrganizationIdProjectProjectIdPublishPutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn organization_id_project_slug_project_slug_get(
    configuration: &configuration::Configuration,
    organization_id: &str,
    project_slug: &str,
) -> Result<crate::models::GetBySlugResponse, Error<OrganizationIdProjectSlugProjectSlugGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/{organization_id}/project/slug/{project_slug}",
        local_var_configuration.base_path,
        organization_id = crate::apis::urlencode(organization_id),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrganizationIdProjectSlugProjectSlugGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
