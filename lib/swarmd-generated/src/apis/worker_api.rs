...
pub async fn organization_id_project_project_id_worker_upload_post(
    configuration: &configuration::Configuration,
    organization_id: &str,
    project_id: &str,
    body: Vec<u8>,
) -> Result<
    crate::models::UploadWorkerResponse,
    Error<OrganizationIdProjectProjectIdWorkerUploadPostError>,
> {
    ...
    let local_var_uri_str = format!(
        "{}/{organization_id}/project/{project_id}/worker/upload",
    ...
    local_var_req_builder = local_var_req_builder.body(Body::from(body));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrganizationIdProjectProjectIdWorkerUploadPostError> =
